...
def main():
    ...
    while(not robot.btn.any()):
        ...
        if c == 10:
            print("sonar1 ", robot.sonar.value() - 50)
    ...
    while not robot.btn.any():
        ...
        if(len(dict) == 3):
            ...
            for key, value in dict.items():
                ...
                if(gyro - 10 <= key <= gyro + 10):
                    tempLhigher.append(value)
                elif(value < gyro):
                    tempLlower.append(value)
                elif(value > gyro):
                    tempLhigher.append(value)
                else:
                    print("FAILED TO EVALUATE GYRO VALUE")
            tempLlower.sort()
            tempLhigher.sort()
            print("lower: ", tempLlower)
            print("higher: ", tempLhigher)
            found_points = tempLhigher + tempLlower
    ...
    if(len(found_points) < 3):
        print("NOT ENOUGH TARGETS FOUND, QUITTING")
        robot.stop()
        return
    ...
    for x in range (0, 2):
        ...
        if(found_points[x] == found_points[2]):
            print("o noeeeeeeeeeeeeeeeeeeeeeeeeeeees.. i wonder what i added this for")
            break
        else:
